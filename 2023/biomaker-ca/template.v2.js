(function (factory) {
  ...
  class FrontMatter {
    constructor() {
      ...
      //
      this.journal = {
        "title": "arXiv preprint arXiv:2307.09320",
        "url": "https://arxiv.org/abs/2307.09320",
      }
      //  journal: {
      //    'title': 'Distill',
      //    'full_title': 'Distill',
...
`;
  ...
  function appendixTemplate(frontMatter) {
    ...
    <pre class="citation short">${frontMatter.concatenatedAuthors}, "${frontMatter.title}", ${frontMatter.journal.title}, ${frontMatter.publishedYear}.</pre>
    <p>BibTeX citation</p>
